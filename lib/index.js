...
const MOUSE_CAPTURE_ON = "\x1b[?1000h\x1b[?1006h";
const MOUSE_CAPTURE_OFF = "\x1b[?1006l\x1b[?1000l";
...
function applyMenuInput(input, cursor, total = MENU_CHOICES.length) {
  ...
  const tokenPattern = /\u001b\[<\d+;\d+;\d+[mM]|\u001b\[M[\s\S]{3}|\u001b(?:\[[0-9;]*[AB]|O[AB])|\r|\n|\u0003|\u001b|[1-9jksw]/gi;
  let match;
  ...
  while ((match = tokenPattern.exec(text)) !== null) {
    ...
    if (/^\u001b(?:\[<\d+;\d+;\d+[mM]|\[M[\s\S]{3})$/i.test(token)) {
      continue;
    }
